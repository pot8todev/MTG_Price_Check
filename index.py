...
def sort_stores_by_diversity(stores: list[Store]) -> Store:
    return sorted(stores, key=lambda store: store.diversity, reverse=True)
...
sorted_stores =  sort_stores_by_diversity(all_stores)
